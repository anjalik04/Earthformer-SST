...
sys.path.insert(0, '/kaggle/working/Earthformer-SST/kd_earthformer')
from src.bias_corrected_student import BiasCorrectedStudent 
...
def main():
    ...
    base_student = pl_module.student.to(device).eval()
    ...
    bias_values = [0.0, 0.25, 0.5, 0.75, 1.0]  # 0.0 = original model, others = corrected
    all_bias_results = {}  # bias -> list of results
